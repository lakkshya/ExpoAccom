  ...
  return (
    <div className="relative">
      ...
      <main className="flex flex-col items-center bg-gray-100">
        <section className="relative w-full flex justify-center !pt-28 !pb-25 lg:!pt-30 lg:!pb-5">
          <div className="w-9/10 flex gap-8 bg-[#0C4C3E] !p-10 rounded-xl">
            <img
              src={event.logo}
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[1.2rem] sm:text-[1.2rem] text-gray-200">
                  {event.location}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <LuCalendarDays className="text-gray-200 text-[1rem] sm:text-[1.4rem]" />
                <span className="text-[1.2rem] text-gray-200">
        ...
        <section className="relative w-full flex justify-center !pb-15">
          <div className="w-9/10 flex justify-center gap-5">
            <div className="w-4/10 flex gap-8 bg-white !p-10 rounded-xl">
              <div
                dangerouslySetInnerHTML={{ __html: event.description }}
              ></div>
            </div>
            <div className="w-6/10 flex gap-8 bg-white !p-10 rounded-xl">
              <form
                action=""
                className="w-full flex flex-col gap-5 text-[0.82rem] xs:text-[0.9rem] text-gray-700 !pt-8 !mt-5"
              >
